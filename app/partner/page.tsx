...
export default function PartnerApp() {
  ...
  if (!session || session.role !== "caretaker") {
    return (
      <main className="lderly-shell flex min-h-screen items-center justify-center px-5 text-white">
        <section className="premium-card w-full max-w-md rounded-[2rem] p-6 text-[#080b10]">
          <p className="text-sm font-semibold text-emerald-700">LDERLY Partner</p>
          <h1 className="premium-title mt-3 text-3xl font-semibold">Caregiver operations</h1>
          ...
          <button
            ...
            className="motion-lift mt-4 w-full rounded-full bg-[#080b10] px-5 py-4 font-semibold text-white"
          >
            Enter Partner App
          </button>
          <button
  ...
  return (
    <main className="lderly-shell">
      <div className="lderly-content mx-auto max-w-lg px-4 py-6">
        ...
        {!hasActiveAssignment && (
          <section className="glass-panel mt-4 rounded-[1.5rem] p-4">
            <div className="flex items-start justify-between gap-4">
              <div>
                <p className="text-sm font-semibold text-emerald-100">Live standby</p>
                <h2 className="mt-1 text-xl font-semibold">Waiting for the next nearby care request</h2>
                <p className="mt-1 text-sm text-white/55">
                  Offers will appear here with accept, travel, OTP start, and completion actions.
                </p>
              </div>
        ...
        <section className="trust-surface motion-lift mt-5 rounded-[1.5rem] p-4">
...
function Metric({
  ...
  return (
    <div className="rounded-2xl bg-white/75 p-3 shadow-inner shadow-emerald-950/5">
...
function ActionButton({
  ...
  return (
    <Button
      ...
      variant="calm"
      className="glass-panel h-auto min-h-24 flex-col rounded-[1.5rem] p-4 disabled:opacity-45"
    >
